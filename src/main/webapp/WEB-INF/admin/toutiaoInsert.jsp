            ...
            <div class="col-md-8 column">
                <form class="form-horizontal" role="form" method="post"
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input type="password" class="form-control"
                                   name="bookBean.book_name" placeholder="请输入密码" id="psw"/>
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input type="password" class="form-control"
                                   name="bookBean.book_name" placeholder="重新输入密码" id="checkPsw" onblur="check()"/>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input type="text" class="form-control"
                                   name="bookBean.book_name" placeholder="请输入名称" />
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input type="email" class="form-control"
                                   name="bookBean.book_name" placeholder="请输入邮箱" />
                        </div>
                    </div>
                    <div class="form-group">
                        <div class="col-sm-offset-2 col-sm-10">
                            <button type="submit" class="btn btn-default">新增头条号</button>
                        </div>
                    </div>
                </form>
            </div>
