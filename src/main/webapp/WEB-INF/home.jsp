...
<link rel="stylesheet" href="${path}/bootstrap/css/home.css" />
<title>头条首页</title>
				...
				<c:forEach var="a" items="${articles}">
					<div class="article">
						<div class="articleImg">
							<a href="#"
								style="text-decoration: none;"><img src="${a.titleImg}" /></a>
						</div>
						<div class="articleTitle">
							<a href="#"
								style="text-decoration: none;"> ${a.title}</a>
						</div>
						<div class="articleTitle" style="font-size: 12px;">
							<!-- <a href="#"
								style="text-decoration: none;"> -->浏览次数：${a.count}<!-- </a> -->
							&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span
								style="color: #999999">发布时间:${a.created}</span>
						</div>
					</div>
				</c:forEach>
			</div>
